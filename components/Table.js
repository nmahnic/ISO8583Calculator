...
const showBitmapList = (campos) => {
    ...
    for(let i=0; i<campos.length ;i++){
        ...
        let textnode1 = document.createTextNode(`Field: ${campos[i]}`)
        ...
        let textnode21 = document.createTextNode(`Length: `)
...
const showDataFieldList = (data) => {
    ...
    let div = document.createElement("div")
    let h3 = document.createElement("h3")
    let h3Text = document.createTextNode("DataFields: ")
    let table = document.createElement("table")
    table.className = "table table-hover table-sm table-dark"
    let tbody = document.createElement("tbody")
    ...
    for(let i=0; i<data.length ;i++){
        let tr = document.createElement("tr")
        let td1 = document.createElement("td")
        let textnode1 = document.createTextNode(`Field: ${data[i].field}`)
        let td2 = document.createElement("td")
        let textnode2 = document.createTextNode(`Data: ${data[i].data}`)
